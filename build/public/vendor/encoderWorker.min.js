...
var Module = typeof Module !== "undefined" ? Module : {};!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.EncoderWorker = t() : e.EncoderWorker = t();
}("undefined" != typeof self ? self : undefined, function () {
  return function (e) {
    function t(s) {
      if (n[s]) return n[s].exports;var i = n[s] = { i: s, l: !1, exports: {} };return e[s].call(i.exports, i, i.exports, t), i.l = !0, i.exports;
    }var n = {};return t.m = e, t.c = n, t.d = function (e, n, s) {
    ...
    (function (t) {
      var n,
        ...
        for (var t = this.interleave(e), n = 0; n < t.length;) {
          var s = Math.min(this.resampleBufferLength - this.resampleBufferIndex, t.length - n);if (this.resampleBuffer.set(t.subarray(n, n + s), this.resampleBufferIndex), n += s, this.resampleBufferIndex += s, this.resampleBufferIndex === this.resampleBufferLength) {
        ...
        }++this.buffersInPage >= this.config.maxBuffersPerPage && this.generatePage();
      }, r.prototype.encodeFinalFrame = function () {
        for (var e = [], n = 0; n < this.config.numberOfChannels; ++n) {
          e.push(new Float32Array(this.config.bufferLength - this.resampleBufferIndex / this.config.numberOfChannels));
        ...
        var e = new DataView(this.segmentData.buffer);e.setUint32(0, 1937076303, !0), e.setUint32(4, 1936154964, !0), e.setUint32(8, 10, !0), e.setUint32(12, 1868784978, !0), e.setUint32(16, 1919247474, !0), e.setUint16(20, 21322, !0), e.setUint32(22, 0, !0), this.segmentTableIndex = 1, this.segmentDataIndex = this.segmentTable[0] = 26, this.headerType = 0, this.generatePage();
      }, r.prototype.generateIdPage = function () {
        var e = new DataView(this.segmentData.buffer);e.setUint32(0, 1937076303, !0), e.setUint32(4, 1684104520, !0), e.setUint8(8, 1, !0), e.setUint8(9, this.config.numberOfChannels, !0), e.setUint16(10, 3840, !0), e.setUint32(12, this.config.originalSampleRateOverride || this.config.originalSampleRate, !0), e.setUint16(16, 0, !0), e.setUint8(18, 0, !0), this.segmentTableIndex = 1, this.segmentDataIndex = this.segmentTable[0] = 19, this.headerType = 2, this.generatePage();
        ...
        for (var t = 0; t < this.config.bufferLength; t++) {
          for (var n = 0; n < this.config.numberOfChannels; n++) {
            this.interleavedBuffers[t * this.config.numberOfChannels + n] = e[n][t];
          }
        }return this.interleavedBuffers;
      }, r.prototype.segmentPacket = function (e) {
        for (var t = 0; e >= 0;) {
          255 === this.segmentTableIndex && (this.generatePage(), this.headerType = 1);var n = Math.min(e, 255);this.segmentTable[this.segmentTableIndex++] = n, this.segmentData.set(this.encoderOutputBuffer.subarray(t, t + n), this.segmentDataIndex), this.segmentDataIndex += n, t += n, e -= 255;
...
}Module["print"] = typeof console !== "undefined" ? console.log : typeof print !== "undefined" ? print : null;Module["printErr"] = typeof printErr !== "undefined" ? printErr : typeof console !== "undefined" && console.warn || Module["print"];Module.print = Module["print"];Module.printErr = Module["printErr"];for (key in moduleOverrides) {
...
}var UTF8Decoder = typeof TextDecoder !== "undefined" ? new TextDecoder("utf8") : undefined;var UTF16Decoder = typeof TextDecoder !== "undefined" ? new TextDecoder("utf-16le") : undefined;var WASM_PAGE_SIZE = 65536;var ASMJS_PAGE_SIZE = 16777216;function alignUp(x, multiple) {
  if (x % multiple > 0) {
  ...
  var wasmTextFile = "encoderWorker.min.wast";var wasmBinaryFile = "encoderWorker.min.wasm";var asmjsCodeFile = "encoderWorker.min.temp.asm.js";if (typeof Module["locateFile"] === "function") {
    ...
    env = fixImports(env);if (!env["table"]) {
      ...
      env["tableBase"] = 0;
    }var exports;exports = doNativeWasm(global, env, providedBuffer);if (!exports) abort("no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods");return exports;
  };
}integrateWasmJS();STATIC_BASE = GLOBAL_BASE;STATICTOP = STATIC_BASE + 35552;__ATINIT__.push();var STATIC_BUMP = 35552;Module["STATIC_BASE"] = STATIC_BASE;Module["STATIC_BUMP"] = STATIC_BUMP;STATICTOP += 16;function _llvm_exp2_f32(x) {
  return Math.pow(2, x);
